    ...
    return (
        <>
            ...
            <div>
                ...
                <h2 className="text-center text-lg text-gray-700">Poznaj najnowsze zmiany w prawie krajowym. Przeglądaj, śledź i bądź na bieżąco z aktualizacjami ustaw, które kształtują naszą rzeczywistość.</h2>
                <hr className="border-t border-gray-300 my-4" />
            </div>
                ...
                <div>
                    ...
                    <tbody>
                        ...
                        <tr key={law.id}>
                            ...
                            <td className="border border-gray-300 p-2"><CountUp   from={0}   separator=","    direction="up"    duration={1}    className="count-up-text" to={law.follows} /></td>
