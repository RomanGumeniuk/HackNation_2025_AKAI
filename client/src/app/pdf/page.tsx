                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    <p className="text-base font-medium text-gray-700">
                      {isDragOver ? 'Upuść dokument tutaj' : 'Przeciągnij i upuść dokument PDF'}
                    </p>
        ...
        <div className="flex flex-col min-h-screen justify-center items-center px-4 py-12 bg-[#EDEFEE]">
          <div className="w-full max-w-3xl">
            <div className="bg-white rounded-lg shadow-sm p-10 border border-gray-200">
              ...
              <h2 className="text-2xl font-bold text-gray-900 text-center mb-2">Przetwarzanie dokumentu</h2>
              <p className="text-gray-600 text-center mb-8">System analizuje przesłany plik PDF</p>
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-base font-semibold text-[#394788]">Wczytywanie dokumentu...</span>
                    </div>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-1.5 overflow-hidden mt-3">
                    <div className="bg-[#394788] h-1.5 rounded-full transition-all duration-500" style={{width: '60%'}}></div>
                  </div>
                </div>
                
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    <p className="text-xs font-semibold text-gray-500 uppercase mb-1">Rozmiar pliku</p>
              ...
              <div className="pt-6 border-t border-gray-200">
                <p className="text-xs font-semibold text-gray-500 uppercase mb-2 text-center">Nazwa dokumentu</p>
                <p className="text-sm font-medium text-gray-900 text-center break-all px-4">{file.name}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="min-h-screen bg-[#EDEFEE] py-8">
          <div className="max-w-6xl mx-auto px-4">
            <div className="flex justify-center items-center">
              <h1 className="m-5 text-[2rem] font-bold leading-snug text-gray-900">{title}</h1>
            </div>
            ...
            {rating && (
              <>
                <div className="flex justify-center items-center m-5">
                  <h1 className="text-2xl font-bold text-gray-900">Analiza wpływu ustawy przez naszego Asystenta Ai</h1>
                </div>
